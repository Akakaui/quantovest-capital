  ...
  return (
    <div className="relative mx-auto flex min-h-[620px] w-full max-w-[1200px] items-center overflow-hidden px-4 py-14 sm:px-6 lg:min-h-[600px] lg:py-16">
      ...
      <div className="pointer-events-none absolute bottom-10 right-[-42px] z-10 h-[420px] w-[310px] sm:right-0 sm:h-[520px] sm:w-[380px] lg:bottom-4 lg:right-6 lg:h-[570px] lg:w-[430px]">
        ...
        <img src="/assets/iphone-16-back-commercial.png" alt="Real iPhone 16 Pro mockup used to frame the Quantovest portfolio signal" className="absolute left-1/2 top-[56%] z-20 h-[430px] w-[165px] -translate-x-1/2 -translate-y-1/2 rotate-[9deg] object-contain sm:h-[500px] sm:w-[180px] lg:h-[560px] lg:w-[205px] drop-shadow-[0_30px_30px_rgba(0,0,0,0.42)]" />
